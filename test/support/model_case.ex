defmodule AppsignalPhoenixExample.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import AppsignalPhoenixExample.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&AppsignalPhoenixExample.ErrorHelpers.translate_error/1)
